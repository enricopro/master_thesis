...
class PPOAgent:
    def __init__(self, state_dim, action_dim, actor_lr=0.00001, critic_lr=0.0001, clip_epsilon=0.2, gamma=0.99, lambda_=0.95, entropy_weight=0.01, model_path="./models/PPO", loaded=False):
