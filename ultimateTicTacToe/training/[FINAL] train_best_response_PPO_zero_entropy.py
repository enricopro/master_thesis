def main():
    ...
    model_dir = "./models/Thesis_PPO_zero_entropy_best_response"
    ...
    setproctitle("training_best_response_ppo_zero_entropy")
    ...
    trained_agent = PPOAgent(state_space_shape, action_space_size, entropy_weight = 0.00, loaded=True, model_path = "./models/Thesis_PPO_zero_entropy")
